...
android {
    ...
    defaultConfig {
        ...
        // Add this for CameraX compatibility
        buildConfigField("String", "COMPILE_SDK_VERSION", "\"${compileSdk}\"")
    }
    ...
    buildFeatures {
        viewBinding = true
        buildConfig = true // Enable build config for API keys
    }
...
dependencies {
    ...
    // CameraX - Updated to latest stable version
